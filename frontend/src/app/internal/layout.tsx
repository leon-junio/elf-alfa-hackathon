        ...
        <div className="flex max-w-7xl mx-auto h-full w-full">
            <aside className="h-full flex flex-col border border-t-0 border-l-0 border-b-0 p-4 space-y-4">
                <Link href="/internal/candidates">
                    <Button variant={pathname === "/internal/candidates" ? "default" : "outline"} className="w-full">
                        <ClipboardList className="w-4 h-4 mr-2" /> Candidatos
                    </Button>
                </Link>
                <Link href="/internal/solicitations">
                    <Button variant={pathname === "/internal/solicitations/" ? "default" : "outline"} className="w-full">
                        <UserCheck2 className="w-4 h-4 mr-2" /> Solicitações
                    </Button>
                </Link>
                <Link href="/internal/reports">
                    <Button variant={pathname === "/internal/reports" ? "default" : "outline"} className="w-full">
                        <Flag className="w-4 h-4 mr-2" /> Relatórios
                    </Button>
                </Link>
                <Link href="/internal/resources">
                    <Button variant={pathname === "/internal/resources" ? "default" : "outline"} className="w-full">
